...
int main() {
    ...
    // Hint: Use a loop to calculate the sum of even numbers in the array
...
# Print the result
print(f"The sum of even numbers in the array is: {sum}")
            `,
            java: `
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("The sum of even numbers in the array is: %d\\n", sum);
    }
}
            `
        };
