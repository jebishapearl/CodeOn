...
int main() {
    ...
    // Hint: Use a loop to calculate the sum of squares of the array elements
...
sum = 0  # Variable to store the sum of squares

# Enter your code logic here
# Hint: Use a loop to calculate the sum of squares of the array elements

# Print the result
print(f"The sum of squares of the array elements is: {sum}")
            `,
            java: `
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("The sum of squares of the array elements is: %d\\n", sum);
    }
}
            `
        };
...
int main() {
    ...
    for (int i = 0; i < N; i++) {
        scanf("%d", &arr[i]);
        sum += arr[i] * arr[i];  // Sum of squares of elements
    }
...
for num in arr:
    sum += num * num  # Sum of squares of elements
